...
document.getElementById('contact-form').addEventListener('submit', function(e) {
    ...
    // Simulate API call
    setTimeout(() => {
        alert('Thank you for your interest! We\'ll get back to you within 2 hours.');
        this.reset();
...
window.addEventListener('load', () => {
    ...
    if (heroVisual) {
        heroVisual.style.animation = 'slideInUp 1s ease 0.3s forwards';
...
document.querySelectorAll('.floating-ui').forEach((ui, index) => {
    ui.style.animationDelay = `${index * 0.5}s`;
});
